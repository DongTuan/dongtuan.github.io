    ...
    if (IS_LOGIN) {
        ...
        if (IS_CONNECT) {
            ...
            if (is_resource($query)) {
                ...
                if ($count == 0) {
                    echo '<li class="normal"><i class="fa fa-dropbox" aria-hidden="true"></i><span class="empty">Không có bảng nào</span></li>';
                } else {
                    $total_size = 0;
                ...
                <ul class="list">
                    <li><i class="fa fa-table" aria-hidden="true"></i> <a href="database_table_create.php' . DATABASE_NAME_PARAMATER_0 . '">Tạo bảng</a></li>';
                ...
                <ul class="list">';
                    ...
                    if (IS_DATABASE_ROOT)
                        ...
                        echo '<li><i class="fa fa-chain-broken" aria-hidden="true"></i> <a href="database_disconnect.php">Ngắt kết nối database</a></li>';
