<?php define('ACCESS', true);
    ...
    if (IS_LOGIN) {
        ...
        if ($dir == null || !is_dir(processDirectory($dir))) {
            ...
            <div class="title">Chức năng</div>
            <ul class="list">
                <li><i class="fa fa-cloud-upload" aria-hidden="true"></i> <a href="upload.php?dir=' . $dirEncode . $pages['paramater_1'] . '">Tải lên tập tin</a></li>
                <li><i class="fa fa-upload" aria-hidden="true"></i> <a href="import.php?dir=' . $dirEncode . $pages['paramater_1'] . '">Nhập khẩu tập tin</a></li>
