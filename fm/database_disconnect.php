<?php
    ...
    if (IS_LOGIN) {
        ...
        if (IS_CONNECT) {
            if ($databases['is_auto']) {
                if (!createDatabaseConfig($databases['db_host'], $databases['db_username'], $databases['db_password'], $databases['db_name'], false)) {
                    ...
                    if (IS_DATABASE_ROOT)
                        ...
                        echo '<li><i class="fa fa-database" aria-hidden="true"></i> <a href="database_tables.php">Danh sách bảng</a></li>';
            ...
            <div class="title">Chức năng</div>
            <ul class="list">
                <li><i class="fa fa-database" aria-hidden="true"></i> <a href="database.php">Kết nối database</a></li>
            </ul>';
        }
