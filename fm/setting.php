<?php define('ACCESS', true);
    ...
    if (IS_LOGIN) {
        ...
        <div class="tips"><i class="fa fa-hand-o-right" aria-hidden="true"></i> Mật khẩu để trống nếu không muốn thay đổi, các phân trang để bằng 0 nếu không muốn phân trang</div>
        <div class="title">Chức năng</div>
        <ul class="list">';

        if ($ref != null)
            echo '<li><i class="fa fa-undo" aria-hidden="true"></i> <a href="' . $ref . '">Quay lại</a></li>';
        else
            echo '<li><i class="fa fa-list-ul" aria-hidden="true"></i> <a href="index.php">Danh sách</a></li>';
