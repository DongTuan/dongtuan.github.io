    ...
    if (IS_LOGIN) {
        ...
        if (IS_CONNECT && IS_DATABASE_ROOT) {
            if (isset($_GET['action']) && $_GET['action'] == 'delete') {
                ...
                echo '<ul class="list">
                    <li><i class="fa fa-database" aria-hidden="true"></i> <a href="database_lists.php">Dang sách database</a></li>
                </ul>';
            } else {
                include_once 'header.php';
                ...
                if (is_resource($query)) {
                    ...
                    <ul class="list">
                        <li><i class="fa fa-creative-commons" aria-hidden="true"></i> <a href="database_create.php">Tạo database</a></li>
                    </ul>';
                } else {
                    echo '<div class="title">' . $title . '</div>
                    ...
                    <div class="title">Chức năng</div>
                    <ul class="list">
                        <li><i class="fa fa-times-circle" aria-hidden="true"></i>
 <a href="database_disconnect.php">Ngắt kết nối database</a></li>
                    </ul>';
                }
            }
            ...
            <div class="title">Chức năng</div>
            <ul class="list">
                <li><i class="fa fa-times-circle" aria-hidden="true"></i> <a href="database_disconnect.php">Ngắt kết nối database</a></li>
            </ul>';
        } else {
            echo '<div class="title">' . $title . '</div>
